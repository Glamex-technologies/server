...
module.exports = class UserController { 
    ...
    async verifyForgotPasswordOtp(req, res) {
        ...
        return response.success('Password updated successfully', res, result);
    }
    ...
    async getAllUsers(req, res) { 
        ...
        try {
            const providers = await userResources.getAllWithPagination(query, attributes, sortBy, sortOrder, page, limit);  
    ...
    async updateUser(req, res) {
        ...
        try {
            ...
            const allowedFields = ['first_name', 'last_name', 'email', 'country_id', 'city_id', 'profile_image',"status","gender"];
            const finalUpdateData = {};
            for (const key of allowedFields) {
                if (key in updateData) { // includes keys with null values too
                    finalUpdateData[key] = updateData[key];
                }
            }
            // Update the user
            const result = await userResources.updateUser(finalUpdateData,  { id: data.user_id });
    ...
    async changePassword(req, res){
        try{
            ...
            await userResources.updateUser({ password: hashedNewPassword }, { id: user.id });
    ...
    async deleteMyAccount(req, res){
        try{
            ...
            await userResources.updateUser({ deleted_at: new Date }, { id: user.id });
